...
+ Mở eclipse, chọn file -> open Projects File From System -> chọn file "Spring Commerce" -> finish
+ Tiếp theo chọn Project trên thanh công cụ -> chọn Clean để rebuild dự án.
+ Tiếp đến start dự án.
